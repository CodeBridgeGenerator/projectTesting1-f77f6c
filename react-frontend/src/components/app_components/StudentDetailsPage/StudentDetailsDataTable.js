...
const file_uploadTemplate2 = (rowData, { rowIndex }) => <div  > </div>
...
<Column field="address" header="Address" body={pTemplate1} filter={selectedFilterFields.includes("address")} hidden={selectedHideFields?.includes("address")}  sortable style={{ minWidth: "8rem" }} />
<Column field="image" header="Image" body={file_uploadTemplate2} filter={selectedFilterFields.includes("image")} hidden={selectedHideFields?.includes("image")}  sortable style={{ minWidth: "8rem" }} />
