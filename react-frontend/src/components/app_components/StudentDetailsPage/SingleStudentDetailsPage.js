...
<div className="col-12"><label className="text-sm text-gray-600">Image</label><div className="m-0 ml-3" ><UploadFilesToS3 type={'single'}/></div></div>
      ...
      <CommentsSection
        recordId={urlParams.singleStudentDetailsId}
        user={props.user}
        alert={props.alert}
