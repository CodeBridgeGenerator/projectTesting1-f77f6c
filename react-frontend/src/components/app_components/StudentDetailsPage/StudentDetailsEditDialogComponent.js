...
const StudentDetailsEditDialogComponent = (props) => {
...
<div className="col-12 field">
                <span className="align-items-center">
                    ...
                    <UploadFilesToS3 type={'edit'} setValByKey={setValByKey} onSave={onSave} id={urlParams.singleStudentDetailsId} serviceName="studentDetails" />
                </span>
                <small className="p-error">
...
export default connect(mapState, mapDispatch)(StudentDetailsEditDialogComponent);
