...
describe("studentDetails service", () => {
  ...
  describe("#create", () => {
    const options = {"name":"new value","address":"new value","image":"new value"};
...
assert.strictEqual(studentDetailCreated.image, options.image);
    });
  });
  ...
  describe("#update", () => {
    ...
    const options = {"name":"updated value","address":"updated value","image":"updated value"};
...
assert.strictEqual(studentDetailUpdated.image, options.image);
    });
  });
